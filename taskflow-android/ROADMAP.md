...
- [x] **#4 Notifications with full context** — WorkManager, full title in BigTextStyle (Notion kill-zone fix)

## Phase 2 — Differentiators
- [x] **#5 Smart daily focus** — `observeDailyFocus()` surfaces 3-5 tasks by deadline + priority
...
- [ ] **#9 Guilt-free deletion UX** — undo snackbar done; insight copy ("3 cleared — good call") TBD

## Phase 3 — Polish
- [ ] **#10 60-second onboarding**
- [x] **#11 Beautiful UI** — Material 3 + Pixel dynamic color + `enableEdgeToEdge()`
- [x] **#12 Habits vs tasks** — `isHabit` field + `observeHabits()` query; UI tab TBD
- [ ] **#13 Swipe-to-reorder** (no drag-and-drop)
- [x] **#14 Priority levels** — LOW/MEDIUM/HIGH enum, color-coded priority bar in `TaskCard`

## Phase 4 — Launch
- [ ] **#15 Accessibility + large text**
- [x] **#16 Firebase Crashlytics** — wired in `build.gradle.kts`
- [ ] **#17 Play Store submission**
- [ ] **#18 Monetization** — personal-only, careful free tier

---

**12 / 18 tasks scaffolded or complete. Next up: #6 recurring task generation, #9 deletion insight copy, #10 onboarding, #13 swipe-to-reorder.**
